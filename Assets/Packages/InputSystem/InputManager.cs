...
namespace Packages.InputSystem
{
    public class InputManager : MonoBehaviour
    {
        ...
        public static void UnsubscribeToStartedAction(InputAction inputAction, Action<InputAction.CallbackContext> function)
        {
            inputAction.started -= function;
        ...
        /// <param name="inputName">The name of the action you want</param>
        /// <param name="function"> The function you want to have unsubscribed</param>
        public static void UnsubscribeToStartedAction(string inputName, Action<InputAction.CallbackContext> function)
        {
            InputAction inputAction = TryGetAction(inputName);
            inputAction.started -= function;
        ...
        public static void UnsubscribeToCanceledAction(InputAction inputAction, Action<InputAction.CallbackContext> function)
        {
            inputAction.canceled -= function;
        ...
        /// <param name="inputName">The name of the action you want</param>
        /// <param name="function"> The function you want to have unsubscribed</param>
        public static void UnsubscribeToCanceledAction(string inputName, Action<InputAction.CallbackContext> function)
        {
            InputAction inputAction = TryGetAction(inputName);
            inputAction.canceled -= function;
